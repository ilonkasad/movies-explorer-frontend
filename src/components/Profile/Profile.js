...
const Profile = ({ isMenuOpen, onMenuForm, onLogoClick, handleProfile, handleMenuClose, EditProfile, handleSignOut, dataUser }) => {
        ...
        <form className="profile">
            ...
            <div className="profile__info">
                ...
                <div className="profile__elem-block">
                    <p>Имя</p>
                    <input name="name" className="profile__elem" value={validation.values.name} onChange={validation.handleChange}></input>
                </div>
                ...
                <div className="profile__elem-block">
                    <p>E-mail</p>
                    <input name="email" className="profile__elem" value={validation.values.email} onChange={validation.handleChange}></input>
                </div>
